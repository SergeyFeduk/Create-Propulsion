...
// TODO: Instances -> Visuals completely changed how basically everything functions, can't port this directly. Will need to be rewritten entirely.

public class PropellerRenderInstance {} // extends KineticBlockEntityVisual<PropellerBlockEntity> implements DynamicVisual {
//    protected final Direction facing;
//    protected RotatingInstance shaft;
//    private PartialModel currentBladeModel;
//
//    protected Instancer<OrientedInstance> headInstancerCutout;
//    protected Instancer<OrientedInstance> bladeInstancerCutout;
//    protected Instancer<OrientedInstance> headInstancerBlur;
//    protected Instancer<OrientedInstance> bladeInstancerBlur;
//
//    private final List<OrientedInstance> transientInstances = new ArrayList<>();
//    private final Vector3f pivot = new Vector3f(PropellerRenderer.pivotX,PropellerRenderer.pivotY,PropellerRenderer.pivotZ);
//
//    public PropellerRenderInstance(VisualizationContext materialManager, PropellerBlockEntity blockEntity, float partialTick) {
...
//        setup(shaft);
//
//        Material cutoutGroup = Materials.CUTOUT_BLOCK;
//        MaterialGroup blurGroup = SimpleMaterial.builder().cutout(PropulsionRenderTypes.PROPELLER_BLUR);
//
//        Material<OrientedInstance> orientedMaterialCutout = cutoutGroup.material(Materials.ORIENTED);
//        Material<OrientedInstance> orientedMaterialBlur = blurGroup.material(Materials.ORIENTED);
//
...
//        for (OrientedInstance instance : transientInstances) {
//            instance.delete();
//        }
...
//        OrientedInstance headData = headInstancerCutout.createInstance();
...
//                OrientedInstance bladeData = bladeInstancerCutout.createInstance();
...
//            OrientedInstance headData = headInstancerBlur.createInstance();
//            transformHeadInstance(headData, rotationalOffset + stroboscopicAngle, (byte) headAlphaInt);
//            transientInstances.add(headData);
//
//            if (bladeInstancerBlur != null) {
//                for (Float placementAngle : blockEntity.renderedBladeAngles) {
//                    OrientedInstance bladeData = bladeInstancerBlur.createInstance();
...
//    }
//
//    private void transformHeadInstance(OrientedInstance instanceData, float totalAngle, byte alpha) {
...
//    }
//
//    private void transformBladeInstance(OrientedInstance instanceData, float totalAngle, byte alpha) {
