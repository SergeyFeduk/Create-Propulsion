...
public class EnvelopeScenes {
    public static void makingBalloon(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay().showText(70)
            .sharedText("making_balloon.intro")
        ...
        scene.overlay().showText(80)
            .attachKeyFrame()
            .sharedText("making_balloon.fill_condition")
        ...
        scene.overlay().showText(70)
            .sharedText("making_balloon.distance_requirement")
        ...
        scene.overlay().showText(60)
            ...
            .sharedText("making_balloon.lever_control")
            .pointAt(util.vector().blockSurface(burnerPos, Direction.NORTH))
            .placeNearTarget();
        scene.idle(70);

        scene.overlay().showText(40)
            .sharedText("making_balloon.power_levels")
            .pointAt(util.vector().blockSurface(burnerPos, Direction.NORTH))
            .placeNearTarget();
        scene.idle(50);
        ...
        scene.overlay().showText(80)
            .sharedText("making_balloon.power_scaling")
            .pointAt(util.vector().blockSurface(burnerPos, Direction.NORTH))
            .placeNearTarget();
        scene.idle(90);
